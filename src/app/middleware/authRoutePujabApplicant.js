...
const { pujabApplicantService } = require('@services/index');
 ...
 */
const loginRequiredPujabApplicant = async (req, res, next) => {
  ...
  if (authorization) {
    try {
      ...
      const tokenUser = await pujabApplicantService.findOnePujabApplicant({
...
module.exports = loginRequiredPujabApplicant;
