...
const createApplicantDiplomaQualificationSchema = Joi.object({
...
const updateApplicantDiplomaQualificationSchema = Joi.object({
...
module.exports = {
  createApplicantDiplomaQualificationSchema,
  updateApplicantDiplomaQualificationSchema,
};
