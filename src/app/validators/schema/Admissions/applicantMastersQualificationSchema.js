...
const createApplicantMastersQualificationSchema = Joi.object({
...
const updateApplicantMastersQualificationSchema = Joi.object({
...
module.exports = {
  createApplicantMastersQualificationSchema,
  updateApplicantMastersQualificationSchema,
};
