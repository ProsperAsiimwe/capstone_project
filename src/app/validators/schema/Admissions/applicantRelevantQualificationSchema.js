...
const createApplicantRelevantQualificationSchema = Joi.object({
...
const updateApplicantRelevantQualificationSchema = Joi.object({
...
module.exports = {
  createApplicantRelevantQualificationSchema,
  updateApplicantRelevantQualificationSchema,
};
