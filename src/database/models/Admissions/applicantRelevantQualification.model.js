...
module.exports = (sequelize, DataTypes) => {
  class ApplicantRelevantQualification extends Model {
    /**
  ...
  ApplicantRelevantQualification.init(
    {
      id: {
    ...
    {
      sequelize,
      modelName: 'ApplicantRelevantQualification',
      tableName: 'applicant_relevant_qualifications',
      underscored: true,
      timestamps: true,
