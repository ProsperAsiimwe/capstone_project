...
module.exports = (sequelize, DataTypes) => {
  class ApplicantCertificateQualification extends Model {
    /**
  ...
  ApplicantCertificateQualification.init(
    {
      id: {
    ...
    {
      sequelize,
      modelName: 'ApplicantCertificateQualification',
      tableName: 'applicant_certificate_qualifications',
      underscored: true,
      timestamps: true,
