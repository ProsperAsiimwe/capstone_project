...
module.exports = (sequelize, DataTypes) => {
  class ApplicantOLevelDataSubject extends Model {
    /**
  ...
  ApplicantOLevelDataSubject.init(
    {
      id: {
    ...
    {
      sequelize,
      modelName: 'ApplicantOLevelDataSubject',
      tableName: 'applicant_o_level_data_subjects',
      underscored: true,
      timestamps: true,
  ...
  return ApplicantOLevelDataSubject;
};
