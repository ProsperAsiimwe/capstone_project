...
module.exports = (sequelize, DataTypes) => {
  class ApplicantBachelorsQualification extends Model {
    /**
  ...
  ApplicantBachelorsQualification.init(
    {
      id: {
    ...
    {
      sequelize,
      modelName: 'ApplicantBachelorsQualification',
      tableName: 'applicant_bachelors_qualifications',
      underscored: true,
      timestamps: true,
