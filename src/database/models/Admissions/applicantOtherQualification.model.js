...
module.exports = (sequelize, DataTypes) => {
  class ApplicantOtherQualification extends Model {
    /**
  ...
  ApplicantOtherQualification.init(
    {
      id: {
    ...
    {
      sequelize,
      modelName: 'ApplicantOtherQualification',
      tableName: 'applicant_other_qualifications',
      underscored: true,
      timestamps: true,
