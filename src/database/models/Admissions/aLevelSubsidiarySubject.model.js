...
module.exports = (sequelize, DataTypes) => {
  class ALevelSubsidiarySubject extends Model {
    /**
  ...
  ALevelSubsidiarySubject.init(
    ...
    {
      sequelize,
      modelName: 'ALevelSubsidiarySubject',
      tableName: 'applicant_a_level_data_subsidiary_subjects',
      underscored: true,
      timestamps: true,
  ...
  return ALevelSubsidiarySubject;
};
