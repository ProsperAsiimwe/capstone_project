...
module.exports = (sequelize, DataTypes) => {
  class ApplicantMastersQualification extends Model {
    /**
  ...
  ApplicantMastersQualification.init(
    {
      id: {
    ...
    {
      sequelize,
      modelName: 'ApplicantMastersQualification',
      tableName: 'applicant_masters_qualifications',
      underscored: true,
      timestamps: true,
