...
module.exports = (sequelize, DataTypes) => {
  class EnrollmentTuitionInvoice extends Model {
    /**
    ...
    static associate(models) {
      ...
      this.tuitionInvoiceFeesElement = this.hasMany(
        models.TuitionInvoiceFeesElement,
        {
          as: 'tuitionInvoiceFeesElement',
          foreignKey: 'tuition_invoice_id',
        }
      );
      this.feesElements = this.hasMany(models.TuitionInvoiceFeesElement, {
        as: 'feesElements',
        foreignKey: 'tuition_invoice_id',
      });
  ...
  EnrollmentTuitionInvoice.init(
    ...
    {
      sequelize,
      modelName: 'EnrollmentTuitionInvoice',
      tableName: 'enrollment_tuition_invoices',
      underscored: true,
      timestamps: true,
  ...
  return EnrollmentTuitionInvoice;
};
