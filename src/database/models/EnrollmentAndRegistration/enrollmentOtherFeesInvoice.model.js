...
module.exports = (sequelize, DataTypes) => {
  class EnrollmentOtherFeesInvoice extends Model {
    /**
    ...
    static associate(models) {
      ...
      this.otherFeesCategory = this.belongsTo(models.MetadataValue, {
        as: 'otherFeesCategory',
        foreignKey: 'other_fees_category_id',
      });
      this.regCourseUnit = this.belongsTo(models.RegistrationCourseUnit, {
        as: 'regCourseUnit',
        foreignKey: 'registration_course_unit_id',
      });
      this.enrlCourseUnit = this.belongsTo(models.EnrollmentCourseUnit, {
        as: 'enrlCourseUnit',
        foreignKey: 'enrollment_course_unit_id',
      });

      this.feesElements = this.hasMany(models.OtherFeesInvoiceFeesElement, {
        as: 'feesElements',
        foreignKey: 'other_fees_invoice_id',
      });

      // Use this to save the fees elements for this invoice
      this.otherFeesInvoiceFeesElements = this.hasMany(
        models.OtherFeesInvoiceFeesElement,
        {
          as: 'otherFeesInvoiceFeesElements',
          foreignKey: 'other_fees_invoice_id',
        }
      );
  ...
  EnrollmentOtherFeesInvoice.init(
    {
      id: {
      ...
      enrollment_course_unit_id: {
        type: DataTypes.BIGINT,
        allowNull: true,
        references: {
          key: 'id',
          model: EnrollmentCourseUnit,
          deferrable: Deferrable.INITIALLY_IMMEDIATE,
        },
      },
      currency: {
    ...
    {
      sequelize,
      modelName: 'EnrollmentOtherFeesInvoice',
      tableName: 'enrollment_other_fees_invoices',
      underscored: true,
      timestamps: true,
  ...
  return EnrollmentOtherFeesInvoice;
};
