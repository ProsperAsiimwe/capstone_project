...
module.exports = (sequelize, DataTypes) => {
  class ChangeOfProgrammeApproval extends Model {
    /**
  ...
  ChangeOfProgrammeApproval.init(
    {
      id: {
    ...
    {
      sequelize,
      modelName: 'ChangeOfProgrammeApproval',
      tableName: 'change_of_programme_approvals',
      underscored: true,
      timestamps: true,
      schema: 'students_mgt',
  ...
  return ChangeOfProgrammeApproval;
};
