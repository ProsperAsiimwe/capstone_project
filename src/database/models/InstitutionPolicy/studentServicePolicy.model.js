...
module.exports = (sequelize, DataTypes) => {
  class StudentServicePolicy extends Model {
    /**
    ...
    static associate(models) {
      ...
      // Model
      this.amounts = this.hasMany(models.StudentServicePolicyAmount, {
        as: 'amounts',
  ...
  StudentServicePolicy.init(
    ...
    {
      sequelize,
      modelName: 'StudentServicePolicy',
      tableName: 'student_services_policy',
      underscored: true,
      timestamps: true,
