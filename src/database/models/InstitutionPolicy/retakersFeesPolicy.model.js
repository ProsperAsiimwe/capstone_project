...
module.exports = (sequelize, DataTypes) => {
  class RetakersFeesPolicy extends Model {
    /**
    ...
    static associate(models) {
      ...
      // save to RetakersFeesPolicyFunctionalFeesElement table
      this.functionalElements = this.hasMany(
        models.RetakersFeesPolicyFunctionalFeesElement,
        {
  ...
  RetakersFeesPolicy.init(
    ...
    {
      sequelize,
      modelName: 'RetakersFeesPolicy',
      tableName: 'retakers_fees_policies',
      underscored: true,
      timestamps: true,
