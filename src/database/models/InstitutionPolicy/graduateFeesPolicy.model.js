...
module.exports = (sequelize, DataTypes) => {
  class GraduateFeesPolicy extends Model {
    /**
    ...
    static associate(models) {
      ...
      // save to GraduateFeesPolicyFunctionalFeesElement table
      this.functionalElements = this.hasMany(
        models.GraduateFeesPolicyFunctionalFeesElement,
        {
  ...
  GraduateFeesPolicy.init(
    ...
    {
      sequelize,
      modelName: 'GraduateFeesPolicy',
      tableName: 'graduate_fees_policies',
      underscored: true,
      timestamps: true,
