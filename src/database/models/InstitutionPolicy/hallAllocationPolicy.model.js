...
module.exports = (sequelize, DataTypes) => {
  class HallAllocationPolicy extends Model {
    /**
    ...
    static associate(models) {
      //
      this.hall = this.belongsTo(models.MetadataValue, {
        as: 'hall',
        foreignKey: 'hall_id',
      });
  ...
  HallAllocationPolicy.init(
    ...
    {
      sequelize,
      modelName: 'HallAllocationPolicy',
      tableName: 'hall_allocation_policies',
      underscored: true,
      timestamps: true,
