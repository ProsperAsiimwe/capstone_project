...
module.exports = (sequelize, DataTypes) => {
  class PreviousStudentPayment extends Model {
    /**
  ...
  PreviousStudentPayment.init(
    ...
    {
      sequelize,
      modelName: 'PreviousStudentPayment',
      tableName: 'previous_student_payments',
      timestamps: true,
      underscored: true,
