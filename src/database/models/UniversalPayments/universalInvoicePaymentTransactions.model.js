...
module.exports = (sequelize, DataTypes) => {
  class UniversalInvoicePaymentTransactions extends Model {
    /**
  ...
  UniversalInvoicePaymentTransactions.init(
    {
      id: {
    ...
    {
      sequelize,
      modelName: 'UniversalInvoicePaymentTransactions',
      tableName: 'universal_invoice_payment_transactions',
      timestamps: true,
      underscored: true,
  ...
  return UniversalInvoicePaymentTransactions;
};
