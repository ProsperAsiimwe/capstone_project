...
module.exports = (sequelize, DataTypes) => {
  class ModuleCourseUnit extends Model {
    /**
    ...
    static associate(models) {
      ...
      this.optionCourseUnits = this.hasMany(models.OptionCourseUnit, {
        as: 'optionCourseUnits',
  ...
  ModuleCourseUnit.init(
    ...
    {
      sequelize,
      modelName: 'ModuleCourseUnit',
      tableName: 'module_course_units',
      underscored: true,
      timestamps: true,
