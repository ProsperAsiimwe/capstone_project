...
const ProgrammeVersionSpecialization = require('./ProgrammeVersionSpecialization.model');
const ProgrammeVersionCourseUnit = require('./programmeVersionCourseUnit.model');

module.exports = (sequelize, DataTypes) => {
  class ProgrammeVersionSpecializationCourseUnit extends Model {
    /**
    ...
    static associate(models) {
      ...
      this.versionSpecialization = this.belongsTo(
        models.ProgrammeVersionSpecialization,
        {
          ...
          foreignKey: 'version_specialization_id',
        }
      );
  ...
  ProgrammeVersionSpecializationCourseUnit.init(
    {
      id: {
    ...
    {
      sequelize,
      modelName: 'ProgrammeVersionSpecializationCourseUnit',
      tableName: 'programme_version_specialization_course_units',
      underscored: true,
      timestamps: true,
  ...
  return ProgrammeVersionSpecializationCourseUnit;
};
