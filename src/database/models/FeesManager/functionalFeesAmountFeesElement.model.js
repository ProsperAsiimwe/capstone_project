...
module.exports = (sequelize, DataTypes) => {
  class FunctionalFeesAmountFeesElement extends Model {
    /**
    ...
    static associate(models) {
      ...
      this.approvals = this.hasMany(models.FunctionalAmountPermission, {
        as: 'approvals',
  ...
  FunctionalFeesAmountFeesElement.init(
    {
      id: {
    ...
    {
      sequelize,
      modelName: 'FunctionalFeesAmountFeesElement',
      tableName: 'functional_fees_amount_fees_elements',
      underscored: true,
      timestamps: true,
      schema: 'fees_mgt',
  ...
  return FunctionalFeesAmountFeesElement;
};
